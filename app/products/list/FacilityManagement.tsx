      ...
      <div className="text-left">
        <div>
          ...
          <p className="text-base font-light text-[#003E57] mt-6">
            Transform the way you manage facilities with our Facility Management
            Solution. This product offers tools for maintenance planning, space
            utilization, and overall facility optimization.
          </p>
        </div>
