...
export default async function WarehouseManagement() {
  const productInfo = await getProduct("Warehouse Management Solution");
      ...
      <div className="grid grid-cols-2 gap-6 mt-4">
        <Card theme={cardTheme} href="#">
          ...
          <p className="text-base font-light text-[#003E57]">
            ...
            employee. The module calculates the payment and all deductions while
            processing remuneration using different wage types
          </p>
        </Card>
        <Card theme={cardTheme} href="#">
          <h5 className="text-lg font-normal text-[#003E57]">
