...
export default async function AssetManagement() {
  const productInfo = await getProduct("Asset Management Solution");
    ...
    <div className="text-left">
      ...
      <div className="grid grid-cols-2 gap-6 mt-4">
        <Card theme={cardTheme} href="#">
          <h5 className="text-lg font-normal text-[#003E57]">Asset Tracking</h5>
        ...
        <Card theme={cardTheme} href="#">
          ...
          <p className="text-base font-light text-[#003E57]">
            Comply with industry standards and your assets manuals to keep your
            employees safe
          </p>
        </Card>
      </div>
