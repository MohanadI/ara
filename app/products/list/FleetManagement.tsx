      ...
      <div className="text-left">
        <div>
          ...
          <p className="text-base font-light text-[#003E57] mt-6">
            Optimize your fleet operations with our Fleet Management Solution.
            This product enhances vehicle tracking, maintenance scheduling, and
            ...
            <Card className="max-w-sm shadow-none">
              <div className="flex flex-col items-center">
                ...
                <p className="text-base text-center font-light text-[#003E57]">
                  Reduce operational costs through optimized routes and
                  maintenance
                </p>
              </div>
            </Card>
