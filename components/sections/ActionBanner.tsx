...
export const ActionBanner = () => {
  return (
    <section className="body-font">
      <div className="containerpx-80 py-24 mx-auto md:px-10 lg:px-20 xl:px-80">
        <div
        ...
        >
          ...
          <div className="flex flex-col w-full mt-3 lg:mt-0 lg:w-1/3 lg:pl-12">
            <button className="flex mx-auto text-black rounded-full bg-white border-0 py-2 px-8 focus:outline-none hover:bg-opacity-60 text-base">
              Get Started{" "}
