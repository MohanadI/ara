    ...
    <Tabs
      ...
      theme={{
        ...
        tablist: {
          ...
          styles: {
            underline:
              "flex-wrap -mb-px -mt-[50px] border-b border-gray-200 dark:border-gray-700",
          },
          tabitem: {
            base: "flex items-center whitespace-break-spaces w-[190px] justify-center p-1 rounded-t-lg text-sm",
            styles: {
              underline: {
                base: "rounded-t-lg",
                active: {
